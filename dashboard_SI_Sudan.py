...
def inject_css(T):
    ...
    css = (
        ...
        /* Conteneur parent du bloc horizontal */
        div[data-testid='stHorizontalBlock'] {
            gap: 8px !important;  /* Augmenté pour plus d'espace entre boutons */
            margin: 0 !important;
            padding: 4px 8px !important;  /* Ajout de padding interne */
        }
        ...
        div[data-testid='stHorizontalBlock'] > div > [data-testid='stButton'] button {
            ...
            font-size: 0.85rem !important;  /* Légèrement augmenté pour meilleure lisibilité */
            font-weight: 500 !important;
            padding: 0.6rem 1rem !important;  /* Padding latéral plus large */
            width: auto !important;  /* Largeur automatique au lieu de 100% */
            min-width: 70px !important;  /* Largeur minimale optionnelle */
        ...
        div[data-testid='stHorizontalBlock'] > div > [data-testid='stButton'] button:hover {
            ...
            border-bottom-color: rgba(227, 0, 27, 0.7) !important;  /* Un peu plus visible */
        }

        /* Option : correction du conteneur parent global (si besoin) */
        .block-container {
            padding-top: 0 !important;  /* Ajuste selon ton layout */
        }
...
def login_page():
    ...
    # Carte supérieure
        ...
        st.markdown(f"<div style='font-size:.72rem;font-weight:700;color:#64748B;letter-spacing:.07em;text-transform:uppercase;margin:.8rem 0 .1rem;'>Password</div>", unsafe_allow_html=True)
